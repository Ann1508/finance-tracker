      ...
      <div className="bg-white rounded-xl p-8 shadow-md border border-gray-200">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-900">Категории доходов и расходов</h4>
              <p className="text-gray-600 text-sm">Создавайте и настраивайте свои категории с иконками и цветами</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl flex-shrink-0">✅</span>
            <div>
              <h4 className="font-semibold text-gray-900">Прикрепление чеков</h4>
              <p className="text-gray-600 text-sm">Загружайте фото чеков и квитанций к каждой транзакции</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl flex-shrink-0">✅</span>
            <div>
              <h4 className="font-semibold text-gray-900">Фильтры и поиск</h4>
              <p className="text-gray-600 text-sm">Фильтруйте транзакции по типу, категории и периоду</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            <span className="text-2xl flex-shrink-0">✅</span>
            <div>
              <h4 className="font-semibold text-gray-900">Статистика в реальном времени</h4>
              <p className="text-gray-600 text-sm">Мгновенный подсчет доходов, расходов и баланса</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Ваши финансовые данные надежно защищены</p>
            </div>
          </div>
        </div>
      </div>
